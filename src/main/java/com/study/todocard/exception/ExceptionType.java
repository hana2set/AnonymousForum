...
public enum ExceptionType {
    ...
    WRONG_ADMIN_PASSWORD(HttpStatus.BAD_REQUEST, "관리자 암호가 일치하지 않습니다."),
    ...
    ONLY_AUTHOR_MOD(HttpStatus.FORBIDDEN, "작성자만 수정이 가능합니다."),
    ONLY_AUTHOR_DEL(HttpStatus.FORBIDDEN, "작성자만 삭제가 가능합니다."),

    NOT_CHOICE_CARD(HttpStatus.BAD_REQUEST, "카드를 선택해주세요."),
    NOT_EXIST_CARD(HttpStatus.BAD_REQUEST, "카드가 존재하지 않습니다."),
